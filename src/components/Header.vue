<template>
  <div class="header">
    ...
    <ul>
      ...
      <li>
        <router-link to="" class="item">新手入门</router-link>
      </li>
      <li>
        <router-link to="" class="item">API</router-link>
      </li>
      <li>
        <router-link to="" class="item">关于</router-link>
      </li>
      <li>
        <router-link to="" class="item">注册</router-link>
      </li>
      <li>
        <router-link to="" class="item">登录</router-link>
      </li>
    </ul>
  </div>
</template>
